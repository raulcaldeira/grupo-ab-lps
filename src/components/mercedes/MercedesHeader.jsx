      ...
      <div className="max-w-content mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="bg-mercedes-red text-white text-sm font-bold px-5 py-2 rounded-lg hover:bg-mercedes-red/90 transition-colors cursor-pointer whitespace-nowrap"
          >
            Agendar test-drive
          </button>
        </div>
